...
export default function CountryCodePicker({ countryCode }: CountryCodeProps) {
  ...
  return (
    <View style={{ overflow: "scroll" }}>
      <TouchableOpacity onPress={handleOnPress} style={{ overflow: "scroll" }}>
        <Text style={{ fontSize: 25, overflow: "scroll" }}>{CountryCodeEmojiMap[countryCode]}</Text>
        <ScrollView
          style={{
            backgroundColor: "white",
            minWidth: 500,
            height: 500,
            display: `${isDropDownDisplayed ? "flex" : "none"}`,
            position: "absolute",
            overflow: "scroll",
          }}
        >
