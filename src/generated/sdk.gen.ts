 ...
 */
export const getInvitationsApiV1UsersUserIdInvitesGet = <ThrowOnError extends boolean = false>(options: Options<GetInvitationsApiV1UsersUserIdInvitesGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetInvitationsApiV1UsersUserIdInvitesGetResponse, GetInvitationsApiV1UsersUserIdInvitesGetError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
