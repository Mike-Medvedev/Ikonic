 ...
 */
export const responseFriendRequestApiV1FriendshipsPatch = <ThrowOnError extends boolean = false>(options: Options<ResponseFriendRequestApiV1FriendshipsPatchData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ResponseFriendRequestApiV1FriendshipsPatchResponse, ResponseFriendRequestApiV1FriendshipsPatchError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
