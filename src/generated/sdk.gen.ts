 ...
 */
export const checkFriendRequestsApiV1FriendshipsUserIdGet = <ThrowOnError extends boolean = false>(options: Options<CheckFriendRequestsApiV1FriendshipsUserIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<CheckFriendRequestsApiV1FriendshipsUserIdGetResponse, CheckFriendRequestsApiV1FriendshipsUserIdGetError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
