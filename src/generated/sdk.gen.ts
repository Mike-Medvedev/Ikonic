 ...
 */
export const getFriendsApiV1FriendshipsGet = <ThrowOnError extends boolean = false>(options?: Options<GetFriendsApiV1FriendshipsGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetFriendsApiV1FriendshipsGetResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
