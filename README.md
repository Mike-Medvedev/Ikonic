...
API Repo -> <a href="https://github.com/Mike-Medvedev/ikonic-api" target="_blank">Ikonic API</a>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center; align-items: center; gap: 16px;">
  ...
  <img src="./assets/screenshots/mvp/TripEditPageLofi.png" alt="Trip Edit Page" width="300" />
